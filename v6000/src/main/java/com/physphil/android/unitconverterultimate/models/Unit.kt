...
sealed class Currency(
    ...
    object AustralianDollar : Currency("AUD", R.string.aud)
    object BulgarianLev : Currency("BGN", R.string.bgn)
    object BrazilianReal : Currency("BRL", R.string.brl)
    object CanadianDollar : Currency("CAD", R.string.cdn)
    object SwissFranc : Currency("CHF", R.string.chf)
    object ChineseYuan : Currency("CNY", R.string.cny)
    object CzechKoruna : Currency("CZK", R.string.czk)
    object DanishKrone : Currency("DKK", R.string.dkk)
    object Euro : Currency("EUR", R.string.eur)
    object BritishPound : Currency("GBP", R.string.gbp)
    object HongKongDollar : Currency("HKD", R.string.hkd)
    object CroatianKuna : Currency("HRK", R.string.hrk)
    object HungarianForint : Currency("HUF", R.string.huf)
    object IndonesianRupiah : Currency("IDR", R.string.idr)
    object IsraeliShekel : Currency("ILS", R.string.ils)
    object IndianRupee : Currency("INR", R.string.inr)
    object IcelandicKrona : Currency("ISK", R.string.isk)
    object JapaneseYen : Currency("JPY", R.string.jpy)
    object KoreanWon : Currency("KRW", R.string.krw)
    object MexicanPeso : Currency("MXN", R.string.mxn)
    object MalaysianRinggit : Currency("MYR", R.string.myr)
    object NorwegianKrone : Currency("NOK", R.string.nok)
    object NewZealandDollar : Currency("NZD", R.string.nzd)
    object PhilippinePeso : Currency("PHP", R.string.php)
    object PolishZloty : Currency("PLN", R.string.pln)
    object RomanianLeu : Currency("RON", R.string.ron)
    object RussianRouble : Currency("RUB", R.string.rub)
    object SwedishKrona : Currency("SEK", R.string.sek)
    object SingaporeDollar : Currency("SGD", R.string.sgd)
    object ThaiBaht : Currency("THB", R.string.thb)
    object TurkishLira : Currency("TRY", R.string.lira)
    object AmericanDollar : Currency("USD", R.string.usd)
    object SouthAfricanRand : Currency("ZAR", R.string.zar)
